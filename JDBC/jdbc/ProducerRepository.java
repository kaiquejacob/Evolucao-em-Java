...
public class ProducerRepository {
    ...
    private static void preparedStatementSaveTransaction(Connection conn, List<Producer> producers) throws SQLException {
        ...
        for (Producer p : producers) {
            try (PreparedStatement ps = conn.prepareStatement(sql)) {
                log.info("Saving jdbc.Producer '{}'", p.getName());
    ...
    public static List<Producer> findByName(String name) {
        log.info("Finding jdbc.Producer by name");
    ...
    public static void showProducerMetaData() {
        log.info("Showing jdbc.Producer MetaData");
    ...
    public static List<Producer> findByNameAndUpdateToUpperCase(String name) {
        log.info("Finding and update jdbc.Producer by name");
        String sql = "SELECT * FROM anime_store.producer WHERE name LIKE '%%%s%%';"
                .formatted(name);
        List<Producer> producers = new ArrayList<>();
        try (Connection conn = ConnectionFactory.getConnection();
...
//                rs.cancelRowUpdates();
    ...
    public static List<Producer> findByNameAndInsertWhenNotFound(String name) {
        log.info("Finding and insert jdbc.Producer by name");
        String sql = "SELECT * FROM anime_store.producer WHERE name LIKE '%%%s%%';"
                .formatted(name);
        List<Producer> producers = new ArrayList<>();
    ...
    public static void findByNameAndDelete(String name) {
        log.info("Finding and delete jdbc.Producer by name");
        String sql = "SELECT * FROM anime_store.producer WHERE name LIKE '%%%s%%';"
                .formatted(name);
        List<Producer> producers = new ArrayList<>();
